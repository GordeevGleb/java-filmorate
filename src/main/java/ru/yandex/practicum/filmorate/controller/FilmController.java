...
public class FilmController {
    ...
    public Film setLike(@PathVariable Long filmId, @PathVariable Long userId) throws UserValidationException {
    ...
    public Film deleteLike(@PathVariable Long filmId, @PathVariable Long userId) throws UserValidationException {
        Film film = filmStorage.getFilmById(filmId);
